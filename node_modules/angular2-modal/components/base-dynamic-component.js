...
var BaseDynamicComponent = (function () {
     ...
     */
    BaseDynamicComponent.prototype._addComponent = function (type, vcRef, bindings, projectableNodes) {
        if (bindings === void 0) { bindings = []; }
        if (projectableNodes === void 0) { projectableNodes = []; }
        var cmpRef = createComponent_1.createComponent(vcRef.injector.get(core_1.ComponentFactoryResolver), type, vcRef, bindings, projectableNodes);
