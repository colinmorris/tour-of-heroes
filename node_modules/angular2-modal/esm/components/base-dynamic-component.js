...
export class BaseDynamicComponent {
     ...
     */
    _addComponent(type, vcRef, bindings=[], projectableNodes=[]) {
        const cmpRef = createComponent(vcRef.injector.get(ComponentFactoryResolver), type, vcRef, bindings, projectableNodes);
